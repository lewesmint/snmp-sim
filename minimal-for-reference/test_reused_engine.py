...
try:
    ...
    result2 = get_sync(
        ...
        auth,
        address,
        [ObjectType(make_oid("1.3.6.1.4.1.99999.1.2.0"))],
        timeout=1.0,
        retries=1,
    )
    ...
    result3 = get_sync(
        ...
        auth,
        address,
        [ObjectType(make_oid("1.3.6.1.4.1.99999.1.3.0"))],
        timeout=1.0,
        retries=1,
    )
...
try:
    ...
    for i in range(5):
        ...
        result = get_next_sync(
            engine3, auth3, address, [current_oid], timeout=1.0, retries=1
        )

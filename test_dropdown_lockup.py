...
class TestDropdownGUI:
    def __init__(self):
        ...
        # Status label
        self.status = tk.Label(self.root, text="Double-click on Column 2 cells to test enum dropdown", 
                               bg="yellow", fg="black")
    ...
    def _show_edit_overlay(self, event, item, column, current_value):
        ...
        self.status.config(text="Select a value from dropdown or press Escape to cancel", bg="lightblue")

...
class TestPluginLoader:
    ...
    def test_load_plugins_from_directory_nonexistent_dir(self, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_load_plugins_from_directory_not_a_dir(self, tmp_path: Path, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_load_plugins_from_directory_bad_spec(self, mocker: Any, tmp_path: Path, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_load_plugins_from_directory_bad_loader(self, mocker: Any, tmp_path: Path, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_load_plugins_from_directory_exec_error(self, mocker: Any, tmp_path: Path, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_load_plugins_from_directory_success(self, mocker: Any, tmp_path: Path, caplog: pytest.LogCaptureFixture) -> None:
    ...
    def test_load_plugins_from_directory_multiple_plugins(self, mocker: Any, tmp_path: Path) -> None:

...
def test_compiled_mibs_have_base_type_info() -> None:
    ...
    for tc_type in tc_types:
        ...
        assert "TextualConvention" in content, "SNMPv2-TC should use TextualConvention"
...
def test_type_info_extraction_from_registry() -> None:
    ...
    # the registry from compiled MIBs at test time so the test can run in
    # environments where data is produced at runtime.
    required = {"OctetString", "Integer32", "ObjectIdentifier"}

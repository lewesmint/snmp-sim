...
def test_cli_no_args_config_not_found(mocker: MockerFixture, capsys: pytest.CaptureFixture[str]) -> None:
...
def test_cli_no_args_with_empty_mib_list(mocker: MockerFixture, capsys: pytest.CaptureFixture[str]) -> None:

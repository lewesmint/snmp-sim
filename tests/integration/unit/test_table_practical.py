...
def test_snmp_engine_with_table_starts(snmp_engine_with_table: engine.SnmpEngine) -> None:
...
def test_mib_view_can_query_unregistered_table(snmp_engine_with_table: engine.SnmpEngine) -> None:
    """

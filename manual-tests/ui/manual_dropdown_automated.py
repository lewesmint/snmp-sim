...
class AutomatedDropdownTest:
    def __init__(self):
        ...
        self.status = tk.Label(
            self.root, text="Starting automated test...", bg="yellow", fg="black"
        )
    ...
    def run_automated_test(self):
        ...
        self.status.config(
            text=f"Running test {self.test_count}/{self.max_tests}...", bg="lightblue"
        )
    ...
    def _save_edit(self):
        ...
        try:
            ...
            self.status.config(
                text=f"Test {self.test_count}: Saved {new_value}", bg="lightgreen"
            )
            print("Save complete")

            # Record successful test
            self.test_results.append(
                f"Test {self.test_count}: PASS - Saved {new_value}"
            )

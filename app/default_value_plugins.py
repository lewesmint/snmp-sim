...
# Type alias for plugin functions
DefaultValuePlugin = Callable[[Dict[str, Any], str], Optional[Any]]
...
class DefaultValuePluginRegistry:
    ...
    def get_default_value(self, type_info: Dict[str, Any], symbol_name: str) -> Optional[Any]:
...
def register_plugin(name: str) -> Callable[[DefaultValuePlugin], DefaultValuePlugin]:
    ...
    Usage:
        ...
        def my_plugin(type_info: Dict[str, Any], symbol_name: str) -> Optional[Any]:
...
def get_default_value(type_info: Dict[str, Any], symbol_name: str) -> Optional[Any]:

...
# Notes
# -----
# ASN.1 source file:///opt/homebrew/opt/net-snmp/share/snmp/mibs/HOST-RESOURCES-MIB.txt
# Produced by pysmi-1.6.2 at Fri Feb  6 11:58:37 2026
# On host Argon.keergill.co.uk platform Darwin version 24.6.0 by user mintz
# Using Python version 3.10.14 (main, Dec 30 2025, 16:07:07) [Clang 17.0.0 (clang-1700.6.3.2)]
...
hrMIBCompliance.setObjects(
      *(("HOST-RESOURCES-MIB", "hrSystemGroup"),
        ("HOST-RESOURCES-MIB", "hrStorageGroup"),
        ("HOST-RESOURCES-MIB", "hrDeviceGroup"))
)
if mibBuilder.loadTexts:
